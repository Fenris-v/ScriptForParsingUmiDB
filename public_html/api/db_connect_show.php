...
$total_records = total_records_show;
...
LIMIT $start_from, $limit";
    ...
    if ($rs_result) {
        ...
        while ($row = mysqli_fetch_array($rs_result)) {
            ...
            $product["item_url"] = 'https://prazdnik-raduga.ru/shou-programmy/' . $row["alt_name"] . '/';
...
WHERE cms3_object_content.obj_id = $obj_id && field_id = 496 || cms3_object_content.obj_id = $obj_id && field_id = 505";
