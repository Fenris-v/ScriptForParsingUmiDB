...
$total_records = total_records_thematic;
...
FROM cms3_objects
JOIN cms3_hierarchy
ON cms3_objects.type_id = 150 && cms3_hierarchy.is_active = 1 && cms3_objects.id = cms3_hierarchy.obj_id && cms3_hierarchy.is_deleted = 0 && cms3_hierarchy.rel = 178
...
LIMIT $start_from, $limit";
    ...
    if ($rs_result) {
        ...
        while ($row = mysqli_fetch_array($rs_result)) {
            ...
            $product["item_url"] = 'https://prazdnik-raduga.ru/tematicheskie-vecherinki/' . $row["alt_name"] . '/';
